...
class AgenticChunker:
    ...
    def add_proposition(self, proposition):
        ...
        print("finding relevant")
        chunk_id = self._find_relevant_chunk(proposition)
        print("finihsed finding relevant")
        ...
        PROMPT = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    If you do not think an item should be joined with an existing chunk, just return "No chunks sucker"
